<x-app-layout>
    <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        <x-slot name="header">
            <div class="flex justify-between items-center">
                <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                    <i class="fas fa-key mr-2"></i> Tokens de Acceso del Usuario: {{ $user->email }}
                </h2>
        ...
        <div class="bg-white shadow-md rounded-lg overflow-hidden mb-6">
            ...
            <div class="p-6">
                <form action="{{ route('admin.users.crearTokenAcceso', ['user' => $user->id]) }}" method="post" class="space-y-4">
                    @csrf
                    <div>
        ...
        <div class="bg-gray-50 rounded-lg p-4 mb-6 shadow-sm">
            <form id="filterForm" method="GET" action="{{ route('admin.users.tokens', ['id' => $user->id]) }}" class="space-y-4">
